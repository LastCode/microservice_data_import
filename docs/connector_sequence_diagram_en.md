...
This document shows the sequence diagrams for interactions between the Connector module and external servers.
...
## LinuxConnector Sequence Diagram
...
## SFTPConnector Sequence Diagram
...
| Step | Source | Target | Data | Protocol/Method |
|------|--------|--------|------|-----------------|
| 1 | Client | FastAPI | HTTP POST Request | REST API |
| 2 | FastAPI | ImportPipeline | ImportRequest | Python function call |
| 3 | ImportPipeline | ConnectorFactory | config, settings | Python function call |
| 4a | LinuxConnector | NAS/Mount | Read file | Filesystem (shutil.copy2) |
| 4b | SFTPConnector | Remote Server | Transfer file | SSH/SCP (subprocess) |
| 5 | Connector | DROPBOX_DIR | Write file | Local filesystem |
| 6 | Pipeline | Neo4j | CSV data | Bolt Protocol (LOAD CSV) |
...
| Component | Protocol | Port | Authentication |
|-----------|----------|------|----------------|
...
| Pipeline ↔ Neo4j | Bolt | 7687 | Username/Password |
...
| `conf/settings.yaml` | Server credentials configuration |
